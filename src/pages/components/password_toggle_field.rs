    ...
    view! {
        <div class="max-w-3xl">
            ...
            <DocSection title="Demo">
                <DemoSection>
                    <div class="max-w-xs space-y-2">
                        ...
                        <PasswordToggleField>
                            <div class="flex items-center rounded-lg border border-slate-300 focus-within:border-accent-500 focus-within:ring-1 focus-within:ring-accent-500">
                                <PasswordToggleFieldInput
                                    attr:class="flex-1 rounded-l-lg border-0 bg-transparent px-3 py-2 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none"
                                    attr:placeholder="Enter password..."
                                />
                                <PasswordToggleFieldToggle attr:class="inline-flex h-9 w-9 items-center justify-center rounded-r-lg text-slate-400 hover:text-slate-600 transition-colors">
            ...
            <DocSection title="Usage">
                <CodeBlock code=r#"use pith_ui::password_toggle_field::*;

view! {
    <PasswordToggleField>
        <div class="field">
            <PasswordToggleFieldInput attr:placeholder="Password" />
            <PasswordToggleFieldToggle>
                <PasswordToggleFieldIcon
                    visible_icon=ViewFn::from(eye_open)
                    hidden_icon=ViewFn::from(eye_closed)
